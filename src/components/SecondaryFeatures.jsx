...
const Feature = ({ feature, isActive, className, ...props }) => {
  return (
    <section
      ...
      // isActive 为假（false），则返回字符串 "opacity-75 hover:opacity-100"，否则返回 false
      {...props}
    >
      {/* ICON */}
      <div
            ...
            <div className="flex -mx-5">
              {features.map((feature, featureIndex) => (
                <Tab.Panel
                  ...
                  style={{ transform: `translateX(-${selectedIndex * 100}%)` }} //这里难点，把图移动了到另一个位置，跟选择相关，会做一个位置的偏移
